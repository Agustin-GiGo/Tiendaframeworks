...
<form>
  <div class="form-group">
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault01" value="Ropa " required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="validationDefault02">Nombre del Producto</label>
      <input type="text" class="form-control" id="validationDefault02" value="Cuello V" required>
    </div>
    <div class="col-md-6 mb-3">
      <label for="validationDefault03">Cantidad</label>
      <input type="text" class="form-control" id="validationDefault03" value="10" required>
    </div>
    <div class="col-md-6 mb-3">
